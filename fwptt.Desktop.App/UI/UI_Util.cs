...
namespace fwptt.Desktop.Util
{
    ...
    {
        public static string PickSaveFile(IWin32Window owner, string filter, string DefaultExt)
        {
        ...
        public static string PickOpenFile(IWin32Window owner, string filter)
        {
